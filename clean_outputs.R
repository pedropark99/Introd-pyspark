### CLEANING SPARK WARNINGS FROM OUTPUTS ----------------------------
## This script is responsible for deleting some Spark log-warnings
## from chunk outputs rendered by quarto. This means that
## this script is intended to run after the HTML outputs
## of each chapter have been generated by quarto.
