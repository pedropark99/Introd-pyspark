...
Every Spark application is distributed into two different and independent processes: 1) a driver process; 2) and a set of executor processes [@chambers2018]. These processes are coordinated by your driver program, which is contained in a object called `SparkContext` [@sparkdoc].

![Spark Application Structure](Figures/spark-application.png){#fig-spark-application fig-align="center"}
