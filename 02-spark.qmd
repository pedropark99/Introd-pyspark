...
Just store the result of this method in any python object. Is very common to name this object as `spark`. This way, you can access all the information and methods of Spark from this `spark` object, like in the example below:
