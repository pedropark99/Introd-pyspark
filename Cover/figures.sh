...
magick convert python.png -gravity center -background '#164E80' -extent 2000x2000 test.png
...
magick mogrify test.png -fill "#164E80" -fuzz 15% -opaque "#FFFFFF" test.png


# The command below I am replacing all black pixels by a null (or empty) pixel
magick mogrify test.png -fill none -fuzz 15% -opaque "#000000" test.png
