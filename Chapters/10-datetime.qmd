...
datetime_pattern = date_pattern + " HH:mm:ss"
user_events = user_events\
    .withColumn('dateOfEvent', to_date(col('dateOfEvent'), date_pattern))\
    .withColumn('timeOfEvent', to_datetime(col('timeOfEvent'), datetime_pattern))
