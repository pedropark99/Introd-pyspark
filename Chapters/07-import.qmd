...
Static files are probably the easiest way to transport data from one computer to another. Because you just need to copy and paste this file to this other machine, or download it from the internet. To read any static file stored inside your computer, **Spark always need to know the file path to this file**.
...
### Reading from other static file formats (JSON, Parquet, ORC)
