...
### Searching for a particular pattern in string values {#sec-filter-pattern-search}
...
#### Using regular expressions or SQL LIKE patterns {#sec-filter-regex-pattern}
...
### Casting columns to a different data type {#sec-cast-column-type}
