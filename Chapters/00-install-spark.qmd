...
You can easily find the location of Java, by running the following command below on the terminal. You see by the result below, that my Java installation is inside a folder called 
...
```
java: C:/Program Files (x86)/Common Files/Oracle/Java/javapath_target_1409750/java.exe
```
