...
![Visualizing the window frames - Part 1](./../Figures/window-spec1.png){#fig-window-spec1 width=80%}
...
![Visualizing the window frames - Part 2](./../Figures/window-spec2.png){#fig-window-spec2 width=80%}
