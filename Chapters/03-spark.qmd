...
We will explain Spark DataFrames in more deth on the @sec-dataframes-chapter. For now just understand that they are the basic data sctructure that feed all `pyspark` programs. 
...
Before we continue, I would like to give you a brief overview of the main classes/modules that exists in `pyspark`. They are:
