...
Every OS comes with a terminal (or a command prompt). A terminal is usually just a black screen where you can send commands to be executed by your OS. The  @fig-terminal-simple-shot shows a print screen of the terminal in Ubuntu. The terminal on Windows is very similar to this.
