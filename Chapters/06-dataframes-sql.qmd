...
Spark SQL is a Spark module for structured data processing [@spark-doc]. Because Spark SQL is a structured module of Spark, you can use it to translate all transformations that you build with the DataFrame API, which is the main structured API of Spark.
